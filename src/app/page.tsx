...
const waLinkRepuesto = "https://wa.me/" + WHATSAPP_REPUESTO + "?text=" + encodeURIComponent(
  ...
  <h2 className={`${holtwood.className} text-[11px] md:text-lg font-black italic leading-none tracking-wider text-white text-right ml-auto translate-y-[5px] md:translate-y-[2px] pr-0 translate-x-[8px] md:translate-x-[12px]`}>
