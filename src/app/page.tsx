...
const waLinkRepuesto = "https://wa.me/" + WHATSAPP_REPUESTO + "?text=" + encodeURIComponent(
  ...
  <h2 className={`${holtwood.className} absolute bottom-[4px] right-[10px] md:bottom-[8px] md:right-[14px] text-[20px] md:text-[13px] font-black italic leading-[0.9] tracking-wider text-white text-right`}>
