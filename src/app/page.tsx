...
const waLinkRepuesto = "https://wa.me/" + WHATSAPP_REPUESTO + "?text=" + encodeURIComponent(
  ...
  <h2 className={`${holtwood.className} text-[10px] md:text-lg font-black italic leading-none tracking-wider text-white text-right ml-auto translate-y-[5px] md:translate-y-[2px] pr-3`}>
