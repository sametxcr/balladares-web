  ...
  return (
    <main className="bg-black text-white overflow-x-hidden">
              ...
              <div className={`${holtwood.className} mt-12 md:mt-20 flex flex-col items-start gap-4 md:gap-6`}>
                {s.title.map((t, li) => (
                  <div key={li} className="racer-wrap" style={{transform: li===1? "skewX(-14deg) translateX(18px)" : "skewX(-14deg)"}}>
                    ...
                    <h1 data-text={t.toUpperCase()} className="racer-main text-[2.1rem] md:text-[3.6rem]">{t.toUpperCase()}</h1>
                  </div>
                ))}
              </div>
      ...
      <section id="nosotros" className="bg-black border-b border-white/5 px-4 md:px-24 py-16 md:py-24">
        <div className="mb-12"><h2 className={`${holtwood.className} text-4xl md:text-7xl font-black italic leading-[0.9]`}>EL PODER DE <span className="text-red-600">UN BUEN SERVICIO</span></h2></div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="bg-black border border-white/10 aspect-[4/3] overflow-hidden"><img src="/entrada.jpg" alt="Entrada 1" className="w-full h-full object-cover" style={{objectPosition:"center center", transform:"scale(0.82)"}} /></div>
          <div className="bg-black border border-white/10 aspect-[4/3] overflow-hidden"><img src="/entrada2.jpg" alt="Entrada 2" className="w-full h-full object-cover" style={{objectPosition:"50% 18%", transform:"scale(0.90)"}} /></div>
          <div className="bg-black border border-white/10 aspect-[4/3] overflow-hidden"><img src="/entradanoche.jpg" alt="Entrada Noche" className="w-full h-full object-cover" style={{objectPosition:"center center", transform:"scale(0.82)"}} /></div>
        </div>
      </section>
                  ...
                  <div className="bg-white" style={{transform:"skewX(3deg)"}}>
                    <div className="relative bg-gradient-to-br from-zinc-50 to-zinc-100 flex items-center justify-center overflow-hidden border-b border-black/5" style={{height:280}}>
                      ...
                      <div className={`absolute inset-0 bg-black/90 p-6 flex flex-col justify-center transition-all duration-300 ${isActive? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"}`}>
                        <div className="text-white font-black italic text-lg mb-2">{s.n.toUpperCase()}</div><div className="text-white/70 text-sm leading-relaxed">{s.d}</div>
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            <div className="relative bg-[#0F0F0F] border- border-red-600 shadow-[6px_6px_0px_#000] p-6 flex flex-col">
              <div className="flex flex-col items-center mb-6 pt-2">
                <div className="w-full bg-black rounded-xl flex items-center justify-center p-4 mb-4"><img src="/icons/isometric_tire_stack_r888r.webp" alt="Neumatico" className="w- h- object-contain" /></div>
            ...
            <div className="relative bg-[#0F0F0F] border- border-white/20 shadow-[6px_6px_0px_#000] p-6 flex flex-col">
              <div className="flex flex-col items-center mb-6 pt-2">
                <div className="w-full bg-black rounded-xl flex items-center justify-center p-4 mb-4"><img src="/icons/red_carbon_sedan_service_icon.webp" alt="Repuesto" className="w- h- object-contain" /></div>
