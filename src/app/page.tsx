...
const waLinkRepuesto = "https://wa.me/" + WHATSAPP_REPUESTO + "?text=" + encodeURIComponent(
  ...
  <h2 className={`${holtwood.className} text-[10px] md:text-[13px] font-black italic leading-none tracking-wider text-white text-right ml-auto pr-0 translate-x-[16px] md:translate-x-[22px]`}>
