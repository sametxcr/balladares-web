...
const WHATSAPP = "56998804732";// numero principal general
const WHATSAPP_NEUMATICO = "56998804732"; // pon aquí el numero de neumáticos
const WHATSAPP_REPUESTO = "56998804732"; // pon aquí el numero de repuestos
...
const slides = [
  ...
  {  title: [""],img: "/IMG_20260923_172830.jpg", imgMobile: "/IMG_20260923_172830.jpg", pos: "55% 100%" },
  {  title: [""],img: "/IMG_20260923_172728.jpg", imgMobile: "/IMG_20260923_172728.jpg", pos: "50% 50%" },
  {  title: [""],img: "/IMG_20260923_171756.jpg", imgMobile: "/IMG_20260923_171756.jpg", pos: "50% 1%" },
...
useEffect(() => {
  setMounted(true);
  if (sessionStorage.getItem("bm_from_ventasticker")) {
    sessionStorage.removeItem("bm_from_ventasticker");
    setShowIntro(false);
  } else {
    ...
    {slides.map((_,idx)=><button key={idx} onClick={()=>setI(idx)} className={`h-1.5 rounded-full transition-all ${idx===i?"w-10 bg-red-600":"w-6 bg-white/30"}`} />)}
     ...
     <section id="nosotros" className="bg-black border-b border-white/5 px-4 md:px-24 py-16 md:py-24">
        ...
        <div className="mb-12">
		  ...
		  <p className="sr-only">
Taller mecánico en Concepción. Balladares Motors especialistas en Repro Stage 1/2, DPF EGR ADBLUE OFF, scanner multimarca, alineación láser 3D y mecánica general. Atendemos Concepción, Chiguayante, Hualpén y San Pedro.
</p>
        </div>
