...
<RoadFighterArcade/>
<h3 className="font-black italic text-1xl text-white uppercase text-center leading-none mt-4 mb-6">juego se cierra de las 3 lineas en la esquina <br/><span className="text-red-600">MARCAS</span></h3>
